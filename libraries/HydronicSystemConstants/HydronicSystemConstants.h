...
const byte floorControlValvePin PROGMEM = relay5Pin;//36;
...
const byte cabControlValvePin PROGMEM = relay6Pin;//37;
...
const byte roomControlValvePin PROGMEM = relay7Pin;//38;
